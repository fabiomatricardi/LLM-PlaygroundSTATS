...
Hugging Face repo: google/flan-t5-base

250M parametrers model
900 Mb HD
...
convHistory = ''
convHistory = ''
mrepo = 'google/flan-t5-base'
modelfile = "Flan-T5-base"
modeltitle = "FLAN-T5-BASE"
modelparameters = '250M'
model_is_sys = False
modelicon = '🍮'
imagefile = './logoBASE.png'
...
llm = AutoModelForSeq2SeqLM.from_pretrained(Flan,
                                             device_map='cpu',
...
def get_plot(period=1):
    ...
    # RAM LINE CHART
    fig = px.line(data, x="x", y='y',height=h,line_shape='spline',range_y=[0,100]) #, width=300
    ...
    # CPU LINE CHART
    fig2 = px.area(data, x="x", y='y1',height=h,range_y=[0,100])  #, width=300 #line_shape='spline'
