...
https://huggingface.co/VivyAI/qwen-1.8B-guanaco-GGUF
Hugging Face repo: VivyAI/qwen-1.8B-guanaco-GGUF

qweN 1.8B quantized
fine tuned with guanaco style dataset

ICON from https://github.com/fabiomatricardi/LLM-PlaygroundSTATS/raw/main/qwen.png
...
convHistory = ''
convHistory = ''
mrepo = 'VivyAI/qwen-1.8B-guanaco-GGUF'
modelfile = "models/qwen-1.8b-guanaco-Q8_0.gguf"
modeltitle = "qwen-1.8B-guanaco"
modelparameters = '1.1 B'
model_is_sys = False
modelicon = '🈚'
imagefile = 'qwen.png'
...
https://www.hardware-corner.net/llm-database/Guanaco/
...
def combine(a, b, c, d,e,f):
    ...
    for character in llm(prompt, 
                ...
                stop=['[PAD151643]', stoptoken], #'<|im_end|>'  '#'  '<|endoftext|>'
