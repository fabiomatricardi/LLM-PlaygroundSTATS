...
-------------------------------------
https://huggingface.co/TKDKid1000/phi-1_5-GGUF
Hugging Face repo: TKDKid1000/phi-1_5-GGUF

The language model Phi-1.5 is a Transformer with 1.3 billion parameters. 
It was trained using the same data sources as phi-1, augmented with a new data source 
that consists of various NLP synthetic texts. When assessed against benchmarks testing 
common sense, language understanding, and logical reasoning, Phi-1.5 demonstrates a nearly 
state-of-the-art performance among models with less than 10 billion parameters.
...
convHistory = ''
convHistory = ''
mrepo = 'TKDKid1000 / phi-1_5-GGUF '
modelfile = "Phi1.5/phi-1_5-Q5_K_M.gguf"
modeltitle = "51-phi-1_5-GGUF"
modelparameters = '1.3B'
model_is_sys = False
modelicon = '♾️'
imagefile = './pansophicSlimOrca.png'
